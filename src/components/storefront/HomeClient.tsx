        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <a
              ...
              aria-label="Facebook"
              className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-[#1877F2] hover:bg-[#145dbf] text-white shadow-md transition-colors shrink-0"
            >
